...
import { createForm, getFormById, getFormByTitle, updateForm } from "../repository/form.repository";
...
export const CreateForm = async (req: express.Request, res: express.Response): Promise<any> => {
    try {
...
export const UpdateForm = async (req: express.Request, res: express.Response): Promise<any> => {
    try {
