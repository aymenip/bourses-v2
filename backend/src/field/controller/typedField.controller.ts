...
export const CreateTypedField = async (req: express.Request, res: express.Response): Promise<any> => {
    try {
...
export const UpdateTypedField = async (req: express.Request, res: express.Response): Promise<any> => {
    try {
