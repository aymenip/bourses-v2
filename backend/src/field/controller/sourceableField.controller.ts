...
} from "../../field/repository/sourceableField.repository";
...
export const CreateSourceableField = async (
  ...
  try {
    ...
    const createdSourceableField = await createSourceableField(
      createSourceableFieldDTO
    );
...
export const UpdateSourceableField = async (
  ...
  try {
    ...
    const updatedSourceabledField = await updateSourceableField(
      updateSourceableFieldDTO
    );
...
export const DeleteSourceableField = async (
  req: express.Request,
  res: express.Response
): Promise<any> => {
  try {
    ...
    await deleteSourceableField(parseInt(id));
